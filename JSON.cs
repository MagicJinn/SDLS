...
namespace SDLS
{
        internal static class JSON
        {
                ...
                public static string ReadInternalJson(string resourceName) // Method for loading embedded JSON resources
                {
                        ...
                        {
                                Plugin.I.Error("Something went seriously wrong and SDLS was not able to load it's own embedded resource.");
                                Plugin.I.Error(ex.Message);
                                return "";
                        }
                }
                ...
                public static void CreateJSON(string strObjJoined, string relativeWritePath)
                {
                        ...
                        {
                                Plugin.I.Error("Error writing file: " + ex.Message);
                        }
                }
                ...
                public static void RemoveJSON(string fullpath)
                {
                        ...
                        {
                                Plugin.I.Warn("Removing " + fullpath);
